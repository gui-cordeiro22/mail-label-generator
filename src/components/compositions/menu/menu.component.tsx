    ...
    <Fragment>
      <MenuContainerTypographyWrapper isSidebarOpened={!!isSidebarOpened}>
        <ScreenWidthRender
          ...
          renderingWidth={1280}
          content={
            <Typography variant="labelLarge" color="info200" text={label} />
          }
        />
        ...
        <ScreenWidthRender
          ...
          renderingWidth={1280}
          content={
            <Typography variant="labelMedium" color="warning100" text={label} />
          }
        />
      </MenuContainerTypographyWrapper>
              ...
              content={
                <Fragment>
                  <Typography
                    ...
                    color={isComingSoon ? "gray200" : "gray400"}
                    text={label}
                  />
...
export const ExpandableMenuItem: FunctionComponent<ExpandableMenuItemProps> = ({
  ...
  return (
    ...
    >
      <ConditionallyRender
        content={
          <ExpandableMenuItemEllipseIndicator isSelected={!!isSelected} />
        }
